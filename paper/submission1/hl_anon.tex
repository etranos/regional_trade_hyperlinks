...
\begin{figure}[p]
\includegraphics[width=1\linewidth]{hl_anon_files/figure-latex/unnamed-chunk-3-1} \caption{\label{accuracy_insample}Accuracy metrics}\label{fig:unnamed-chunk-3}
\end{figure}
...
\begin{figure}[p]
\includegraphics[width=1\linewidth]{hl_anon_files/figure-latex/unnamed-chunk-7-1} \caption{\label{prediction}Predicted vs. observed interregional trade by year}\label{fig:unnamed-chunk-7}
\end{figure}
...
\begin{figure}[p]
\includegraphics[width=1\linewidth]{hl_anon_files/figure-latex/unnamed-chunk-11-1} \caption{\label{alt.accuracy}Accuracy metrics for alternative specifications}\label{fig:unnamed-chunk-11}
\end{figure}
...
\begin{figure}[p]
\includegraphics[width=1\linewidth]{hl_anon_files/figure-latex/unnamed-chunk-13-1} \caption{\label{prediction_multi_pc}Predicted vs. observed interregional trade by year for multiple postcodes}\label{fig:unnamed-chunk-13}
\end{figure}
