...
Below is the plot for the hyperlink flow data for all years and for all NUTS2 pairs with 100 or more hyperlinks.
...
# Trade flow predictions between LADs

Bellow are the the trade flow predictions between Local Authority Districts.
