---
title: "I/O and hyperlinks for multiple postcodes, data and descriptives"
...
Also, we consider commercial website that contain multiple UK postcodes in the text.

```{r echo=FALSE, results= 'hide', message=FALSE, warning=FALSE}

files.path <- paste0(path, "/data/NUTS210_hyperlinks/multiple_pc_weighted")
files <- list.files(path=files.path,
                    pattern = "^NUTS210")
n <- 1999

for(i in files){
  file <- paste(path, "/data/NUTS210_hyperlinks/multiple_pc_weighted/", i, sep = "")
