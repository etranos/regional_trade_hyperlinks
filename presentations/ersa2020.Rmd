...
## Modelling strategy
$$trade_{ijt} = hyperlinks_{ijt} + distance_{ij} + \\
pop.density_{it} + pop.density_{it} + empl_{it} + empl_{jt} + e_{ijt}$$
...
- RF is a tree-based ensemble learning method [@breiman2001random]
